 ...
 */
public class CustomUrlSecondaryDrawerItem extends CustomUrlBaseSecondaryDrawerItem<CustomUrlSecondaryDrawerItem, CustomUrlSecondaryDrawerItem.ViewHolder> implements ColorfulBadgeable<CustomUrlSecondaryDrawerItem> {
  protected StringHolder mBadge;
  protected BadgeStyle mBadgeStyle = new BadgeStyle();

  @Override
  public CustomUrlSecondaryDrawerItem withBadge(StringHolder badge) {
    this.mBadge = badge;
    return this;
  }

  @Override
  public CustomUrlSecondaryDrawerItem withBadge(String badge) {
    this.mBadge = new StringHolder(badge);
    return this;
  }

  @Override
  public CustomUrlSecondaryDrawerItem withBadge(@StringRes int badgeRes) {
    this.mBadge = new StringHolder(badgeRes);
    return this;
  }

  @Override
  public CustomUrlSecondaryDrawerItem withBadgeStyle(BadgeStyle badgeStyle) {
  ...
  @Override
  public int getType() {
    return R.id.material_drawer_item_custom_url_item_secondary;
  }
