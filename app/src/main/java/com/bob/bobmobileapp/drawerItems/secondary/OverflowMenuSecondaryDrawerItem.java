 ...
 */
public class OverflowMenuSecondaryDrawerItem extends BaseDescribeableDrawerItem<OverflowMenuSecondaryDrawerItem, OverflowMenuSecondaryDrawerItem.ViewHolder> {
  private int mMenu;

  public OverflowMenuSecondaryDrawerItem withMenu(int menu) {
    this.mMenu = menu;
    return this;
  }
  ...
  public OverflowMenuSecondaryDrawerItem withOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener onMenuItemClickListener) {
  ...
  public OverflowMenuSecondaryDrawerItem withOnDismissListener(PopupMenu.OnDismissListener onDismissListener) {
  ...
  @Override
  public int getType() {
    return R.id.material_drawer_item_overflow_menu_secondary;
  }

  @Override
  @LayoutRes
  public int getLayoutRes() {
    return R.layout.material_drawer_item_overflow_menu_secondary;
  }
